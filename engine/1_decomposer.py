...
Table name:"""
    ...
    def _extract_entities(self, query: str) -> List[str]:
        """Extract entities using fuzzy matching and search function"""
        entities = search_financial_terms(query)
        return [match['term'] for match in entities]
    ...
    def decompose_query(self, query: str, chat_history: List[Dict] = None) -> List[Dict]:
        ...
        try:
            ...
            for sub_query in sub_queries:
                ...
                entities = self._extract_entities(sub_query)
